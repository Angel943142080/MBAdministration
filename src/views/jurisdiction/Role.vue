  ...
  <div class="box">
      ...
      <el-form style="width: 100%" :inline="true" class="demo-form-inline">
        ...
        <el-col :span="5">
          <el-form-item label="创建人">
            <el-input v-model="founder" placeholder="请输入创建人"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="5">
    ...
    <div class="tableBox">
      ...
      >
        ...
        <el-table-column prop="founder" label="创建人" min-width="200" />
  ...
  setup() {
    ...
    const btnState = reactive({
      ...
      newRole: () => {
        ...
        btnState.dialogTitle = '新增角色' //新增角色
        btnState.confirmDisplay = true //显示确定和取消按钮
        btnState.joinTime = false //隐藏加入日期
        // 初始化新增角色数据
        newRuleState.roleName = '' //角色名称
        newRuleState.department = '' //所属部门
        newRuleState.departmentOptions = [
          {
            value: 'Option1',
            label: '开发部',
          },
