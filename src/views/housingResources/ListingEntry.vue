  ...
  <div class="box">
    ...
    <div class="tableBox">
      ...
      >
        ...
        <el-table-column prop="storeCover" label="房源封面展示 " />
        <el-table-column prop="storeName" label="房源名称" />
    ...
    >
      ...
      <div v-show="isDialogType === 'newlyAdded'" class="newlyAddedMain">
        <StoreList @release="onConfirm" :dialogTitle="dialogTitle"></StoreList>
      </div>
      <!-- 排序 -->
...
import StoreList from './ListAdd.vue' //新增门店
