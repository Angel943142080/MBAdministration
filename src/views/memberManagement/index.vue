  ...
  <div class="member">
    ...
    <el-form class="form" ref="memberForm">
      <el-row :gutter="15">
        ...
        <el-col :span="3.5">
          <el-form-item>
            <el-input v-model="keyword" placeholder="请选择类型"></el-input>
          </el-form-item>
        </el-col>
    ...
    >
      ...
      <el-table-column prop="integral" label="公司" min-width="200" />
      <el-table-column prop="integral" label="身份证号" min-width="200" />
      <el-table-column prop="integral" label="姓名" min-width="200" />
      <el-table-column prop="integral" label="手机号" min-width="200" />
      <el-table-column prop="integral" label="房间号" min-width="200" />
      <el-table-column prop="integral" label="租户类型" min-width="200" />
      <el-table-column label="操作" fixed="right" width="200">
        <template #default>
          <el-button type="success" size="small" @click="openPop(true)">
            查看
          </el-button>
    ...
    <div>
      <info :dialogVisible="isopen" @updateSwitch="openPop(e)" />
    </div>
    <!-- 弹窗 -->
  </div>
</template>
...
<script>
import info from '@/components/Detail/detail.vue'
