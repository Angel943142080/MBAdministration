...
<template>
  <div class="box">
    ...
    >
      ...
      <el-tab-pane label="活动推荐" name="recommend">
        <!-- 表单 -->
        <el-row class="form" :gutter="20">
          <el-form
            style="width: 100%"
            ...
            <el-table-column label="操作" fixed="right">
              <template #default="scope">
                <el-button
                  type="text"
                  size="small"
                  @click="tipClick(scope.row.state)"
                >
                  {{ scope.row.state === '已发布' ? '下架' : '删除' }}
                </el-button>
              </template>
            </el-table-column>
          </el-table>
      ...
      <el-tab-pane label="审核" name="preferred">
        <!-- 表单 -->
        <el-row class="form" :gutter="20">
          <el-form
            style="width: 100%"
        ...
        <div class="tableBox">
          ...
          >
            ...
            <el-table-column prop="approvalOperation" label="审批操作" />
            ...
            <el-table-column label="" min-width="100px">
              <template #default="scope">
                <el-button size="small" @click="tipClick(scope.row.state)">
                  报名名单
                </el-button>
              </template>
            </el-table-column>
      ...
      <div v-show="dialogType === 'RmAddNewly'" class="RmAddNewlyMain">
        <div class="content">
          <el-row>
            ...
            <el-col :span="3" :offset="4">活动地址</el-col>
            <el-col :span="7">
              <el-input
                v-model="RmAddDialogState.addressValue"
                placeholder="请输入活动地址"
              ></el-input>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="7">
              <el-date-picker
                v-model="RmAddDialogState.activityTime"
                type="datetimerange"
                range-separator="至"
            ...
            <el-col :span="3" :offset="4">活动人数</el-col>
            <el-col :span="7">
              <el-input
                v-model="RmAddDialogState.activityNumber"
                placeholder="请输入活动人数"
              ></el-input>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="3">活动群里名称</el-col>
            <el-col :span="7">
              <el-input
                v-model="RmAddDialogState.activityGroupChat"
                placeholder="请输入活动群里名称"
              ></el-input>
            </el-col>
            <el-col :span="3" :offset="4">只允许租户参与</el-col>
            <el-col :span="7">
              <el-radio-group v-model="RmAddDialogState.tenant">
          ...
          <el-row>
            <el-col :span="3">活动详情</el-col>
            <el-col :span="7">
              <el-input
                v-model="RmAddDialogState.activityDetails"
                placeholder="请编辑活动详情"
              ></el-input>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="7" class="releaseTime">
              <el-date-picker
                v-model="RmAddDialogState.releaseTime"
                type="datetime"
                placeholder="请选择发布时间"
      ...
      <div v-show="dialogType === 'RmSee'" class="RmSeeMain">
        ...
        <el-row class="header" :gutter="20">
          ...
          <el-col :span="4">
            <div>
              报名人数 :
              <span style="color: #ff7c00">420</span>
              /500
            </div>
          </el-col>
          <el-col :span="4">
          ...
          <el-col :span="4" v-show="activeName === 'preferred'">
        ...
        <div class="content">
          <el-row>
            <el-col :span="3">活动标题</el-col>
            <el-col :span="7">
              {{ sseAddDialogState.addressValue || '这里是活动标题' }}
            </el-col>
            <el-col :span="3" :offset="4">活动地址</el-col>
            <el-col :span="7">
              {{ sseAddDialogState.addressValue || '这里是活动地址' }}
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="3">活动时间</el-col>
            <el-col :span="7">
              {{ sseAddDialogState.activityTime }}
            </el-col>
            <el-col :span="3" :offset="4">活动人数</el-col>
            <el-col :span="7">
              {{ sseAddDialogState.activityNumber }}
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="3">活动群里名称</el-col>
            <el-col :span="7">
              {{ sseAddDialogState.activityGroupChat }}
            </el-col>
            <el-col :span="3" :offset="4">只允许租户参与</el-col>
            <el-col :span="7">
              {{ sseAddDialogState.tenant == 1 ? '是' : '否' }}
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="3" style="display: flex; align-items: start">
          ...
          <el-row>
            <el-col :span="3">活动详情</el-col>
            <el-col :span="7" style="color: #ff7c00">查看</el-col>
          </el-row>
          <el-row>
            <el-col :span="3">发布时间</el-col>
            <el-col :span="7" class="releaseTime">
              {{ sseAddDialogState.releaseTime }}
            </el-col>
          </el-row>
        </div>
      </div>
        ...
        table: [
          {
            imgExhibition: '白领精致房9304', //图片展示
            title: '白领精致房9304', //标题
            activityDate: '2021-6-1 - 2022-6-1', //活动日期
            releaseDate: '2021-5-13', //发布日期
            publisher: '李四四', //发布人
            state: '已发布', //状态
            numberApplicants: '666', //报名人数
            views: '15615', //浏览量
            reviewer: '王五', //审核人
            approvalOperation: 'A类型', //审批操作
          },
          {
            imgExhibition: '白领精致房9304', //图片展示
            title: '白领精致房9304', //标题
